...
from models.ensemble import Ensemble ,Ensemble_soft , Ensemble_logits,Ensemble_soft_baseline
...
def test(args,loader, models, criterion, epoch, device, writer=None, print_freq=10):
